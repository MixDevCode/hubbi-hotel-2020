...
$total_pages_sql = "SELECT COUNT(*) FROM bans";
						...
						<div class="row">
							<div class="col-md-12">
                                <div class="table-data__tool">
									...
									<h3 class="title-5 m-b-35">Baneos</h3>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <a href="index.php?apartado=seguridad&seccion=agregar-baneo" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>Agregar</a>
										<a href="index.php?apartado=seguridad&seccion=buscar-baneo" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
											<?php
												$sql = ("SELECT * FROM bans ORDER BY ID DESC LIMIT $offset, $no_of_records_per_page");
												$result = $link->query($sql);
												if ($row = mysqli_fetch_array($result)){ 
												do {
													echo "<tr class='tr-shadow'>
                                                <td>".$row['value']."</td>
                                                <td>". gmdate('d-m-Y',$row['added_date'])."</td>
                                                <td>
                                                    <span class='block-email'>".$row['reason']."</span>
                                                </td>
                                                <td class='desc'>".$row['added_by']."</td>
                                                <td>". gmdate('d-m-Y',$row['expire'])."</td>
												<td></td>
                                                <td>
												<div class='table-data-feature'>
                                                    <a href='/hk/index.php?apartado=seguridad&seccion=eliminar-baneo&id=".$row['id']."' class='item' data-toggle='tooltip' data-placement='top' title='' data-original-title='Eliminar'>
