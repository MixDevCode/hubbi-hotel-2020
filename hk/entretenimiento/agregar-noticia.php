                    ...
                    <div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								...
								$sqlsdsd = "INSERT INTO cms_news (title, shortstory, longstory, author, date, image, type)".
										"VALUES ('$title2', '$desc2', '$noti2', '$userid', '$timestamp', '$image', 1)";
								$result = $link->query($sqlsdsd);
								
								$sqldsd = "INSERT INTO cms_logen (nombre, accion, fecha)".
								"VALUES ('$user', 'Ha creado la noticia $title2', '$horario')";
								$link->query($sqldsd);
							   ...
							   <textarea name="longstory" id="editor1"></textarea>
									<script>
										CKEDITOR.replace( 'editor1' );
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    <span id="payment-button-amount">Agregar noticia</span>
                                                </button>
                                            </div>
											</form>
								<?php
