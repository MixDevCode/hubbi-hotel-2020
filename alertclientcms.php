 ...
 <link rel="stylesheet" href="/themes/<?= $config['skin']; ?>/assets/css/client.css?<?=$hotel['cache']; ?>" type="text/css">
...
<div class="ca3">
<div style="background:url('/themes/<?= $config['skin']; ?>/assets/images/template.png?2');" class="ca4"></div>
